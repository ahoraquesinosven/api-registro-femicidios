export default {
  ...
  properties: {
    ...
    judicialMeasures: {
      type: "array",
      items: { $ref: "#/components/schemas/CaseJudicialMeasure" },
    },
    victimBondAggressor: {
      $ref: "#/components/schemas/CaseVictimBondAggressor",
    },
    isRape: { type: "boolean" },
    ...
    aggressor: {
      ...
      properties: {
        ...
        behaviourPostCase: {
          type: "array",
          items: { $ref: "#/components/schemas/CaseAggressorBehaviorPostCase" },
        },
        belongsSecurityForce: { type: "boolean" },
        securityForce: {
          $ref: "#/components/schemas/CaseAggressorSecurityForce",
        },
      },
      additionalProperties: false,
    },
