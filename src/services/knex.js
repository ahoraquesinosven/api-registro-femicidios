...
const unaccentedMatchExpression = (field, value) =>
  knex.raw("unaccent(:field:) ILIKE unaccent(:value)", {
    field,
    value: `%${value}%`,
  });
...
Knex.QueryBuilder.extend(
  "toNestedObjects",
  async function ({ rootQualifier, fields }) {
